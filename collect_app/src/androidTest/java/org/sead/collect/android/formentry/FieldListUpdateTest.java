...
import static org.sead.collect.android.support.actions.NestedScrollToAction.nestedScrollTo;
import static org.sead.collect.android.test.CustomMatchers.withIndex;
...
public class FieldListUpdateTest {
    ...
    public void questionsAppearingBeforeCurrentBinaryQuestion_ShouldNotChangeFocus() throws IOException {
        ...
        Bitmap icon = BitmapFactory.decodeResource(ApplicationProvider.getApplicationContext().getResources(), R.drawable.sead);
