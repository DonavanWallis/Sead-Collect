...
import org.sead.collect.android.openrosa.OpenRosaConstants;
...
import org.sead.collect.android.test.MockedServerTest;
...
import static org.sead.collect.android.test.TestUtils.assertMatches;
import static org.sead.collect.android.test.TestUtils.cleanUpTempFiles;
import static org.sead.collect.android.test.TestUtils.createTempFile;
import static org.sead.collect.android.test.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.sead.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));
