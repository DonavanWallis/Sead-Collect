package org.sead.collect.android.tasks.sms;
...
import org.sead.collect.android.events.SmsRxEvent;
import org.sead.collect.android.jobs.SmsSenderJob;
...
import org.sead.collect.android.provider.InstanceProviderAPI;
...
import org.sead.collect.android.tasks.sms.models.Message;
import org.sead.collect.android.tasks.sms.models.SmsProgress;
import org.sead.collect.android.tasks.sms.models.SmsSubmission;
import org.sead.collect.android.upload.InstanceServerUploader;
import org.sead.collect.android.utilities.ArrayUtils;
...
import static org.sead.collect.android.analytics.AnalyticsEvents.SUBMISSION;
import static org.sead.collect.android.tasks.sms.SmsNotificationReceiver.SMS_NOTIFICATION_ACTION;
import static org.sead.collect.android.tasks.sms.SmsSender.SMS_INSTANCE_ID;
import static org.sead.collect.android.tasks.sms.SmsSender.SMS_MESSAGE_ID;
import static org.sead.collect.android.tasks.sms.SmsSender.SMS_RESULT_CODE;
import static org.sead.collect.android.tasks.sms.SmsSender.checkIfSentIntentExists;
import static org.sead.collect.android.utilities.FileUtil.getFileContents;
import static org.sead.collect.android.utilities.FileUtil.getSmsInstancePath;
