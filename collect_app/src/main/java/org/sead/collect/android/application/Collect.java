...
package org.sead.collect.android.application;
...
import org.sead.collect.android.injection.config.AppDependencyComponent;
import org.sead.collect.android.injection.config.DaggerAppDependencyComponent;
...
import org.sead.collect.android.preferences.AutoSendPreferenceMigrator;
import org.sead.collect.android.preferences.FormMetadataMigrator;
...
import org.sead.collect.android.preferences.PrefMigrator;
...
import org.sead.collect.android.utilities.LocaleHelper;
import org.sead.collect.android.utilities.NotificationUtils;
...
import static org.sead.collect.android.logic.PropertyManager.PROPMGR_USERNAME;
import static org.sead.collect.android.logic.PropertyManager.SCHEME_USERNAME;
import static org.sead.collect.android.preferences.GeneralKeys.KEY_APP_LANGUAGE;
import static org.sead.collect.android.preferences.GeneralKeys.KEY_FONT_SIZE;
import static org.sead.collect.android.preferences.GeneralKeys.KEY_USERNAME;
import static org.sead.collect.android.tasks.sms.SmsNotificationReceiver.SMS_NOTIFICATION_ACTION;
import static org.sead.collect.android.tasks.sms.SmsSender.SMS_SEND_ACTION;
...
public class Collect extends Application {
     ...
     * and application version name: {@code Dalvik/<version> (platform info) org.sead.collect.android/v<version>}.
     *
