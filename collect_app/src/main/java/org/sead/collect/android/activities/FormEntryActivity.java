...
package org.sead.collect.android.activities;
...
import org.sead.collect.android.audio.AudioControllerView;
import org.sead.collect.android.dao.FormsDao;
import org.sead.collect.android.dao.helpers.ContentResolverHelper;
import org.sead.collect.android.dao.helpers.FormsDaoHelper;
import org.sead.collect.android.dao.helpers.InstancesDaoHelper;
import org.sead.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.sead.collect.android.events.RxEventBus;
import org.sead.collect.android.exception.JavaRosaException;
import org.sead.collect.android.external.ExternalDataManager;
import org.sead.collect.android.formentry.FormLoadingDialogFragment;
import org.sead.collect.android.formentry.ODKView;
import org.sead.collect.android.formentry.QuitFormDialog;
import org.sead.collect.android.formentry.SaveFormProgressDialogFragment;
import org.sead.collect.android.formentry.audit.AuditEvent;
import org.sead.collect.android.formentry.audit.AuditUtils;
import org.sead.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.sead.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.sead.collect.android.formentry.audit.IdentityPromptViewModel;
import org.sead.collect.android.formentry.backgroundlocation.BackgroundLocationHelper;
import org.sead.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.sead.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.sead.collect.android.formentry.repeats.AddRepeatDialog;
import org.sead.collect.android.formentry.saving.FormSaveViewModel;
import org.sead.collect.android.fragments.MediaLoadingFragment;
import org.sead.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.sead.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.sead.collect.android.fragments.dialogs.NumberPickerDialog;
import org.sead.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.sead.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.sead.collect.android.listeners.AdvanceToNextListener;
import org.sead.collect.android.listeners.FormLoaderListener;
import org.sead.collect.android.listeners.PermissionListener;
import org.sead.collect.android.listeners.SavePointListener;
import org.sead.collect.android.listeners.WidgetValueChangedListener;
import org.sead.collect.android.location.client.GoogleLocationClient;
import org.sead.collect.android.logic.FormController;
import org.sead.collect.android.logic.FormController.FailedConstraint;
import org.sead.collect.android.logic.FormInfo;
import org.sead.collect.android.logic.ImmutableDisplayableQuestion;
import org.sead.collect.android.preferences.AdminKeys;
import org.sead.collect.android.preferences.AdminSharedPreferences;
import org.sead.collect.android.preferences.GeneralKeys;
import org.sead.collect.android.preferences.GeneralSharedPreferences;
import org.sead.collect.android.preferences.PreferencesActivity;
import org.sead.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.sead.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.sead.collect.android.storage.StorageInitializer;
import org.sead.collect.android.storage.StoragePathProvider;
import org.sead.collect.android.storage.StorageSubdirectory;
import org.sead.collect.android.tasks.FormLoaderTask;
import org.sead.collect.android.tasks.SaveFormIndexTask;
import org.sead.collect.android.tasks.SaveFormToDisk;
import org.sead.collect.android.tasks.SavePointTask;
import org.sead.collect.android.upload.AutoSendWorker;
import org.sead.collect.android.utilities.ApplicationConstants;
import org.sead.collect.android.utilities.DestroyableLifecyleOwner;
import org.sead.collect.android.utilities.DialogUtils;
import org.sead.collect.android.utilities.FileUtils;
import org.sead.collect.android.utilities.FormNameUtils;
import org.sead.collect.android.utilities.ImageConverter;
import org.sead.collect.android.utilities.MediaManager;
import org.sead.collect.android.utilities.MediaUtils;
import org.sead.collect.android.utilities.PermissionUtils;
import org.sead.collect.android.utilities.PlayServicesUtil;
import org.sead.collect.android.utilities.ScreenContext;
import org.sead.collect.android.utilities.SnackbarUtils;
import org.sead.collect.android.utilities.SoftKeyboardUtils;
import org.sead.collect.android.utilities.ToastUtils;
import org.sead.collect.android.widgets.DateTimeWidget;
import org.sead.collect.android.widgets.QuestionWidget;
import org.sead.collect.android.widgets.RangeWidget;
import org.sead.collect.android.widgets.StringWidget;
...
import static org.sead.collect.android.analytics.AnalyticsEvents.LAUNCH_FORM_WITH_BG_LOCATION;
import static org.sead.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.sead.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.sead.collect.android.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.sead.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.sead.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.sead.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.sead.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.sead.collect.android.utilities.ToastUtils.showLongToast;
import static org.sead.collect.android.utilities.ToastUtils.showShortToast;
